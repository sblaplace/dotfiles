    ...
    in
    {
      nixosConfigurations = {
        ...
        nix.settings = {
          ...
          extra-trusted-public-keys = [
            "cuda-maintainers.cachix.org-1:0dq3b12Gpjk7Tj1jtV5J3VQlGJ4G3P4cP8qSYSfl4YA="
          ];
        };
        ...
        raspi02 = mkNixosSystem {
          hostname = "raspi02";
          system = "aarch64-linux";
        };
        raspi03 = mkNixosSystem {
          hostname = "raspi03";
          system = "aarch64-linux";
        };
        raspi04 = mkNixosSystem {
          hostname = "raspi04";
          system = "aarch64-linux";
        };
      ...
      deploy.nodes = {
        neovenezia = {
          ...
          profiles.system = {
            user = "root";
            sshUser = "laplace";
            path = deploy-rs.lib.x86_64-linux.activate.nixos self.nixosConfigurations.neovenezia;
          };
        };
      ...
      apps.x86_64-linux = {
        ...
        deploy-cluster = {
          type = "app";
          program = toString (
            nixpkgs.legacyPackages.x86_64-linux.writeShellScript "deploy-cluster" ''
        ...
        bootstrap-cluster = {
          type = "app";
          program = toString (
            nixpkgs.legacyPackages.x86_64-linux.writeShellScript "bootstrap-cluster" ''
              set -e
